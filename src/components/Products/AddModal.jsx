...
const AddProductModal = ({ isOpen, setIsOpen, fetchAlldata }) => {
    ...
    <>
      <div className="relative z-[1000] border-accentMain">
        <Modal
          ...
          className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  z-[9999] rounded-[12px]     outline-none bg-mainBg w-[335px] h-[484px] md:h-[412px] md:w-[536px]"
        >
          <div className="px-5 py-10 md:px-10 relative">
            ...
            <h2 className="text-customXxl font-semibold">Add a new product</h2>
            <AddProductForm
