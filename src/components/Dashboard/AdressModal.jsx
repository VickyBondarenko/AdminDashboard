...
const AdressModal = ({ isOpen, setIsOpen, customer }) => {
    ...
    <>
      <div className="relative z-[1000] border-accentMain">
        <Modal
          ...
          overlayClassName="fixed top-0 right-0 bottom-0 left-0 bg-red z-[9] pointer-events-auto backdrop-brightness-[0.7]"
        ...
        >
          <div className="px-5 py-10 md:px-10 relative text-center">
            ...
            <div className="py-10">{address}</div>
          </div>
        </Modal>
      </div>
    </>
