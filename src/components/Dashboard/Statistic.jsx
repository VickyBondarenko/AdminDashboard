...
const Statistic = ({ title, count, icon }) => {
  return (
    <>
      <div className=" bg-white w-[157px] md:w-[221px] xl:w-[240px] h-[100px] p-[14px] border border-borderLight hover:border-accent focus:border-accent rounded-lg flex flex-col gap-8">
